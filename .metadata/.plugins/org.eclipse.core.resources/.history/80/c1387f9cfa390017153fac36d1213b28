					...
					<div class="container " style="margin-top: 5%; margin-bottom: 5%;">
						<div class="panel panel-default" style="max-width: 55%;"
							...
							<div class="panel-body">
								                       
								<form ction="servlet/LoginServlet" method="doPost">
									<div class="form-group">
										<label for="userAccount" class="control-label">
											用户名
										</label>
										<input type="text" class="form-control" name="userAccount"
											id="userAccount" placeholder="请输入用户名" required="required" />
										           
									</div>
									                           
									<div class="form-group">
							...
							<div class="panel-footer" align="right">
								<a href="/BookStore/JSP/UserCenterPage.jsp">前往用户管理中心</a>
							</div>
							<div class="panel-footer" align="left">
								<a href="/BookStore/JSP/RegisterPage.jsp">创建新账户</a>
							</div>
